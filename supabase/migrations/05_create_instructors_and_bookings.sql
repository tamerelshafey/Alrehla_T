...
-- DROP TABLE IF EXISTS bookings CASCADE;   -- ⚠️ معطّل: كان بيمسح الجدول وكل المرتبط بيه
-- DROP TABLE IF EXISTS instructors CASCADE;   -- ⚠️ معطّل: كان بيمسح الجدول وكل المرتبط بيه
