    ...
    <header className="h-20 px-6 md:px-12 flex justify-between items-center border-b border-slate-200 bg-white/80 backdrop-blur-md sticky top-0 z-50">
      <div className="flex items-center gap-10">
        ...
        <nav className="hidden lg:flex gap-6 text-[14px] font-bold text-slate-600">
          ...
          <Link href="/creative-writing" className="hover:text-blue-600 transition-colors">بداية الرحلة</Link>
          <Link href="/about" className="hover:text-blue-600 transition-colors">رحلتنا</Link>
          <Link href="/blog" className="hover:text-blue-600 transition-colors">المدونة</Link>
          <Link href="/join-us" className="hover:text-blue-600 transition-colors">انضم إلينا</Link>
          <Link href="/support" className="hover:text-blue-600 transition-colors">الدعم والمساعدة</Link>
        </nav>
      </div>
      
      <div className="flex items-center gap-4">
        <Link href="/cart" className="p-2 text-slate-600 hover:text-blue-600 transition-colors">
